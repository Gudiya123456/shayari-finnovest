...
export default function CreateLeads({ showDrawer, setShowDrawer }) {
            ...
            >
                <div className="flex flex-col h-screen overflow-hidden">
                    <div className="w-full text-center border-b border-grey p-4">
                        ...
                        <h4 className="mb-1 dark:text-white font-bold"> <span className='text-yellow-500' ></span> Create Leads</h4>
                    </div>
