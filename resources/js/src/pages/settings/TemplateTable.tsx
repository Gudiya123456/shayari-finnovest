...
const TemplateTable = () => {
    ...
    const fetchAuthorization = async () => {
        ...
        try {
            const response = await axios({
                method: 'get',
                url: window.location.origin + '/api/sms',
                headers: {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Sms'));
    });
    const [page, setPage] = useState(1);
    const PAGE_SIZES = [10, 20, 30, 50, 100];
    const [pageSize, setPageSize] = useState(PAGE_SIZES[0]);
    const [initialRecords, setInitialRecords] = useState(sortBy(authList, 'id'));
        ...
        Swal.fire({
            ...
            if (result.value) {
                try {
                    const response = await axios({
                        method: 'delete',
                        url: window.location.origin + "/api/sms/" + data.id,
                        headers: {
                            'Content-Type': 'application/json',
                            Authorization: 'Bearer ' + token,
                        },
            ...
            <div className="mb-5 flex items-center justify-between">
                ...
                >
                    <div className="relative">
                        ...
                        <button type="button" className="hover:opacity-80 sm:hidden block absolute top-1/2 -translate-y-1/2 ltr:right-2 rtl:left-2" value={search} onChange={(e) => setSearch(e.target.value)}>
                            <IconXCircle />
                        </button>
                    </div>
                </form> */}
                ...
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'dropdown_type', title: 'Sender Id', sortable: true },
...

                            {
                                ...
                                render: ({ status }) => <label className="w-12 h-6 relative">
                                    <p className=' flex justify-center rounded-md bg-amber-500 text-white' >Active</p>
                                </label>,
                            },
                            ...
                            <div className="flex items-start justify-center min-h-screen px-4">
                                ...
                                >
                                    <Dialog.Panel as="div" className="panel border-0 p-0 rounded-lg overflow-hidden my-8 w-full max-w-lg text-black dark:text-white-dark">
                                        <div className="flex bg-white dark:bg-[#121c2c] items-center justify-center text-center px-5 py-3">
                                            <div>
                                                <div className="text-xl"> {params.id?'Update':'New'}Template</div>
                                                <p className='text-gray-400' >If you need more information,please check</p>
                                            </div>
                                        ...
                                        <div className="p-5 pt-0">
                                            <div className="mb-10">
                                                <select
                                                    ...
                                                    name='dropdown_type' value={params.dropdown_type} onChange={(e) => changeValue(e)} >
                                                    ...
                                                    <option className="" value='finnovest'

                                                    >
                                                        Finnovest
                                                    </option>
                                                    <option className="" value='hello'
                                            ...
                                            <div className="mb-10">
                                                <input
                                                    type="text"
                                                    className="input-form dark:border-[#5E5E5E] placeholder-black dark:bg-transparent"
